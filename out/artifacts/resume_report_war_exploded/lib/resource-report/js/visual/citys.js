...
var GeoCoord = getCityPos();

function getCityPosEx(c){
    if(c in GeoCoord)return GeoCoord[c];
    if(c+'市' in GeoCoord)return GeoCoord[c+'市'];
    if(c+'自治州' in GeoCoord)return GeoCoord[c+'自治州'];
    if(c+'自治县' in GeoCoord)return GeoCoord[c+'自治县'];
    if(c+'地区' in GeoCoord)return GeoCoord[c+'地区'];
    if(c+'盟' in GeoCoord)return GeoCoord[c+'盟'];
    return null;
}
