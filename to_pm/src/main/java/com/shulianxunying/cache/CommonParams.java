...
public class CommonParams {
    ...
    // 用户身份
    public static final int ACCOUNT_TYPE_B = 1;
    public static final int ACCOUNT_TYPE_B_SUB = 2;

    public static final int ACCOUNT_TYPE_PM_ROOT = 1;
    public static final int ACCOUNT_TYPE_PM_ADMIN = 2;
    public static final int ACCOUNT_TYPE_PM_NORMAL = 3;
    ...
    static {
        INIT_B_POWER.add(POWER_REPORT_COLLECT);  //100
        INIT_B_POWER.add(POWER_REPORT_DOWNLOAD); //101
        ...
        INIT_B_POWER.add(POWER_REPORT_5);
        INIT_B_POWER.add(POWER_REPORT_6);

        INIT_PM_POWER.add(POWER_ADD_ACCOUNT);  //1
        INIT_PM_POWER.add(POWER_ADD_INFO);  //3
        INIT_PM_POWER.add(POWER_REPORT_COLLECT); //100
        INIT_PM_POWER.add(POWER_REPORT_DOWNLOAD); //101
        INIT_PM_POWER.add(POWER_REPORT_1);
        INIT_PM_POWER.add(POWER_REPORT_2);
        INIT_PM_POWER.add(POWER_REPORT_3);
        INIT_PM_POWER.add(POWER_REPORT_4);
        INIT_PM_POWER.add(POWER_REPORT_5);
        INIT_PM_POWER.add(POWER_REPORT_6);
    }
}
