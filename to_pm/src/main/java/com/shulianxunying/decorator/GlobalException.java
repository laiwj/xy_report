...
import com.shulianxunying.annotation.AuthException;
...
public class GlobalException extends ExceptionHandlerExceptionResolver {
    ...
    protected ModelAndView doResolveHandlerMethodException(HttpServletRequest request, HttpServletResponse response, HandlerMethod handlerMethod, Exception exception) {
        ...
        if (null != reqType && reqType.equals("XMLHttpRequest")) {//ajax请求
            ...
            }else if(((UndeclaredThrowableException) exception).getUndeclaredThrowable() instanceof AuthException) {
                model.setData("没有权限").setMsg("没有权限");
//                model.setData("没有权限");
            }
            else {
