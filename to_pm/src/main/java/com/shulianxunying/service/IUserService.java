...
public interface IUserService {
    ...
    Model b_user_list(PMUser op_user, String user_id,String pm_user_id, int page, int pageSize);

    Model addPower(PMUser op_user, String user_id, String source, List<Integer> power, List<Integer> power_del);

    Model sendEmail(PMUser op_user, String email, String username, String info) throws IOException;
}
