...
public class NoticeServiceImpl implements INoticeService {
    ...
    @Override
    public Model send_notice_to_users(String msg, Set<String> user_ids,String mess_type) {
        int step = 50;
        ...
        for (String id : user_ids) {
            ...
            noticeInfo.setMess_type(mess_type);
    ...
    @Override
    public Model send_notice_to_all(String msg,String mess_type) {
        MongoCursor<Document> iterator = userDao.getCollection(MPMUserDao.b_user_collection).find().projection(new Document("_id", 1)).iterator();
        int step = 50;
        ArrayList<Document> data = new ArrayList<>();
        int count = 0;
