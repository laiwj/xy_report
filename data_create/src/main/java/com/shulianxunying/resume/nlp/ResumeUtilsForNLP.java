 ...
 */
public class ResumeUtilsForNLP implements Serializable {
     ...
     * @return
     */
    public static JavaPairRDD<Document, ResumeTypeForNLP> resumeTag(JavaPairRDD<Document, ResumeTypeForNLP> dimenResume) {
     ...
     * @return
     */
    public static JavaPairRDD<Document, ResumeTypeForNLP> resumeTag(JavaPairRDD<Document, ResumeTypeForNLP> dimenResume, List<String> steps) {
        // gender
        if (steps.contains("gender")) {
            dimenResume = dimenResume.mapToPair(new PairFunction<Tuple2<Document, ResumeTypeForNLP>, Document, ResumeTypeForNLP>() {
                public Tuple2<Document, ResumeTypeForNLP> call(Tuple2<Document, ResumeTypeForNLP> tuple2) throws Exception {
        ...
        if (steps.contains("keywords")) {
            ...
            dimenResume = dimenResume.mapToPair(new PairFunction<Tuple2<Document, ResumeTypeForNLP>, Document, ResumeTypeForNLP>() {
                @Override
                public Tuple2<Document, ResumeTypeForNLP> call(Tuple2<Document, ResumeTypeForNLP> documentResumeTypeForNLPTuple2) throws Exception {
                    String self_introduction = (String) documentResumeTypeForNLPTuple2._1().getOrDefault("self_introduction", "");
                    Object skillList = documentResumeTypeForNLPTuple2._1().get("skillList");
                    if (skillList == null)
                    ...
                    ArrayList<Document> certificateList = (ArrayList<Document>) documentResumeTypeForNLPTuple2._1().get("certificateList");
                    ...
                    ArrayList<Document> workExperienceList = (ArrayList<Document>) documentResumeTypeForNLPTuple2._1().get("workExperienceList");
                    if (workExperienceList != null && workExperienceList.size() > 0) {
                    ...
                    documentResumeTypeForNLPTuple2._2.setKeywords(segmentLine);
                    return documentResumeTypeForNLPTuple2;
                }
            });
        }
        return dimenResume;
