...
(function($) {
	...
	$.alerts = {
		...
		alert: function(message,  callback,icon ,showIframe) {
			icon = icon == undefined ? "/lib/jqueryalert/images/alert.gif" :icon;
		...
		tip: function(message, time, callback,icon, showIframe) {
			//icon = icon == undefined ? "/lib/jqueryalert/images/success.gif" :icon;
            icon = icon == undefined ? "/images/success.png" :icon;
		...
		_show: function( msg, value, type, callback,icon, showIframe) {
			...
			$("BODY").append(
			  '<div id="popup_container">' +
			    ...
			    '<div id="popup_content">' +
			      '<div id="popup_message"><img src="'+icon+'"><br /><div id="popup_messageText"></div><div id="pop_body"></div></div>' +
				'</div>' +
			  '</div>');
			...
			if(!msg.firstOne){
				...
				$("#popup_messageText").text(msg.firstOne);
				$("#popup_messageText").html( $("#popup_message").text().replace(/\n/g, '<br />') );
				$('#pop_body').text(msg.secOne)
			}
