...
import com.shulianxunying.controller.EnumResultCode;
...
public class SystemLogAspect {
    ...
    public Object process(ProceedingJoinPoint point) throws Throwable {
        ...
        logInfo.setSession_id(requestedSessionId);
        logInfo.setUrl(url);
...
//            System.out.println(returnValue);
            ...
            logInfo.setE("没有权限");
            returnValue = new Model(EnumResultCode.RESULTCODE_AUTH_FAIL.getCode(),EnumResultCode.RESULTCODE_AUTH_FAIL.getDescription());
        } catch (Exception e) {
            logInfo.setE(e.getMessage());
        ...
        try {
            ...
            if (returnValue != null) {
                ...
                returnValue = model;
                logInfo.setResult(model.toJSONString());
            }
